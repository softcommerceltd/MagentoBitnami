...
class Wm_Productslider_Block_List extends Mage_Catalog_Block_Product_List
{
    protected $defaultTemplate = 'wm/productslider/home.phtml';
    ...
    protected function _getConfiguration($path = 'productslider_cfg')
    {
